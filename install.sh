...
wget -N --no-check-certificate https://raw.githubusercontent.com/fun90/shadowsocks_install/master/shadowsocksR.sh
...
#Install SWEB
cd /usr/local/
git clone https://github.com/fun90/SWEB
...
wget -N --no-check-certificate -O /usr/local/bin/sweb https://raw.githubusercontent.com/fun90/SWEB/master/sweb
